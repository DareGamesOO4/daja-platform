  ...
  async posaljiLinkZaPromenuLozinke(input: {
    ...
    await this.posaljiEmail({
      ...
      html: htmlPromenaLozinke({
        ...
        socialIcons: {
          facebook: emailAssetUrl('/images/email-social-facebook-circle.png'),
          instagram: emailAssetUrl('/images/email-social-instagram-circle.png'),
          tiktok: emailAssetUrl('/images/email-social-tiktok-circle.png')
        }
      }),
      tag: 'promena-lozinke'
    });
...
function htmlPromenaLozinke(input: {
  ...
  return (
    ...
    '<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:26px auto 28px"><tr><td class="reset-button-cell" align="center" bgcolor="#111111" style="background-color:#111111;border-radius:6px"><a class="reset-button" href="' +
    resetUrl +
    ...
    '<table class="reset-security-card" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#fafafa" style="width:100%;border-collapse:collapse;background-color:#fafafa;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden"><tr><td align="center" bgcolor="#fafafa" style="padding:18px 22px;background-color:#fafafa">' +
    '<p class="reset-security-label" style="margin:0 0 5px;color:#27272a;font-size:13px;line-height:1.4;font-weight:700">Vreme za postavljanje nove lozinke</p>' +
    '<p class="reset-security-value" style="margin:0;color:#71717a;font-size:13px;line-height:1.55">Link važi 30 minuta. Kada istekne, možete zatražiti novi.</p>' +
    '</td></tr></table>' +
    ...
    '<td style="padding:0 8px"><a href="https://facebook.com" aria-label="Facebook" style="display:block;width:32px;height:32px;text-decoration:none"><img src="' +
    socialIcons.facebook +
    '" alt="Facebook" width="32" height="32" style="display:block;width:32px;height:32px;border:0" /></a></td>' +
    '<td style="padding:0 8px"><a href="https://instagram.com" aria-label="Instagram" style="display:block;width:32px;height:32px;text-decoration:none"><img src="' +
    socialIcons.instagram +
    '" alt="Instagram" width="32" height="32" style="display:block;width:32px;height:32px;border:0" /></a></td>' +
    '<td style="padding:0 8px"><a href="https://tiktok.com" aria-label="TikTok" style="display:block;width:32px;height:32px;text-decoration:none"><img src="' +
    socialIcons.tiktok +
    '" alt="TikTok" width="32" height="32" style="display:block;width:32px;height:32px;border:0" /></a></td>' +
    ...
    currentYear +
    ' DajaShop. Sva prava zadržana.</td></tr>' +
