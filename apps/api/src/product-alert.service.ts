...
function priceChangeEmail(input: {
  ...
  return (
    ...
    url +
    '" style="color:#e30613;text-decoration:underline;word-break:break-all">' +
    url +
    '</a></p>' +
